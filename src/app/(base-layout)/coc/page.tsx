    ...
    return (
        <>
            <div className="mt-12 mb-12  ml-4 mr-4 lg:mr-28 lg:ml-28 mx-auto space-y-4">
                ...
                <p className="text-xl">
                    <strong>1. Be Respectful:</strong> Treat others with
                    kindness and respect. Disagreements may arise, but it&apos;s
                    essential to engage in constructive and courteous
                    discussions.
                </p>
                ...
                <p className="text-xl">
                    <strong>3. No Harassment:</strong> Harassment of any kind is
                ...
                <p className="text-xl">
                    <strong>4. Respect Privacy:</strong> Be mindful of
                    others&apos; privacy. Do not share personal information
                    without explicit consent.
                </p>

                <p className="text-xl">
                    <strong>5. Stay on Topic:</strong> Keep discussions and
                    contributions relevant to the community. Off-topic content
                    may be redirected or removed.
                </p>

                <p className="text-xl">
                    <strong>6. No Spam:</strong> Avoid spamming, including
                    excessive self-promotion or unrelated content. This helps
                    maintain a focused and valuable community space.
                </p>
