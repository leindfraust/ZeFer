...
export default function SeriesManageContainer() {
    ...
    const [modalActionAddPostSeries, setModalActionAddPostSeries] = useState<
        PostSeries | undefined
    >();
    const [modalActionRemoveSeries, setModalActionRemovePostSeries] = useState<
        PostSeries | undefined
    >();
    ...
    return (
        <div className="container">
            <button
                ...
                onClick={() => modalSeries.current?.show()}
            >
                Create Series
            </button>
            ...
            <div className="flex flex-wrap gap-4 mt-4">
                            ...
                            <div className="flex flex-col gap-4 shadow-lg hover:outline outline-gray-400 rounded-lg ">
                                ...
                                <div className="flex justify-end gap-4 p-4">
                                    <button
                                        ...
                                        onClick={() =>
                                            setModalActionAddPostSeries(series)
                                        }
                                    >
                                        Add a Post
                                    </button>
                    ...
                    <dialog className="modal" ref={modalAddPostToSeries}>
                        <div className="modal-box">
                            <h3 className="text-xl">
                                Add a Post to{" "}
                                <strong>
                                    {modalActionAddPostSeries.title}
                                </strong>
                            </h3>
                            <QueryWrapper>
                                <SeriesManagePostContainer
                                    {...modalActionAddPostSeries}
                                    action="add"
                                />
                            </QueryWrapper>
                ...
                {modalActionRemoveSeries && (
                    <dialog className="modal" ref={modalRemovePostToSeries}>
                        <div className="modal-box">
                            <h3 className="text-xl">
                                Remove a Post to{" "}
                                <strong>{modalActionRemoveSeries.title}</strong>
                            </h3>
                            <QueryWrapper>
                                <SeriesManagePostContainer
                                    {...modalActionRemoveSeries}
