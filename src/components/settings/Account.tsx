        ...
        <>
            <div className="mx-auto lg:w-9/12 justify-center">
                <div className="shadow-lg p-12 rounded-md space-y-2">
                    ...
                    <h1 className="text-3xl font-bold text-error pt-4">
                        Danger Zone
                    </h1>
                    {providers.length > 1 && (
                        <>
                    ...
                    <div className="container pt-4">
                        ...
                        <p className="text-md mt-4">
                            Deleting your account will remove all your posts,
                            reactions, comments and your information stored
                            within our database.
                        </p>
                        <div className="mt-4 mb-4">
                            <input
                                ...
                                onChange={(e) =>
                                    setInputDelete(e.currentTarget.value)
                                }
                            />
                            <p className="text-sm mt-2">
                                Type &quot;DELETE&quot; to proceed on deleting
                                your account.
                            </p>
                        </div>
                        <button
